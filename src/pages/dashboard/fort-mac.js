...
import { ArrowLeft, Wind, Droplets, Thermometer, ExternalLink } from 'lucide-react'
    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-lg mx-auto px-4 py-7 space-y-5">
        <div>
          ...
          <p className="font-body text-white/35 text-sm mt-0.5">Fort McMurray, Alberta &middot; Wood Buffalo</p>
        </div>
        ...
        <p className="font-body text-white/15 text-xs text-center pb-4">
          Weather via Open-Meteo · News via local RSS feeds
        </p>
      </main>
    </div>
  )
